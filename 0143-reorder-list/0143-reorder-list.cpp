...
public:
    void reorderList(ListNode* head) {
        ...
        // iterate the first haft and insert the second half one after another
        // in first half exit the loop when second is nullptr we don't need to
        // check first because for first half is one node more than second half
        // in odd list
