...
public:
    int characterReplacement(string s, int k) {
        ...
        for (int i = 0; i < static_cast<int>(s.size()); ++i) {
            ...
            // while window length(i-left+1) minus maxFrequency in window is
            // greater than k, means that this window is invalid
            ...
            // update the result if window length is greater than previous
            // resulet
