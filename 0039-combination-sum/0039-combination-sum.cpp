...
public:
    vector<vector<int>> combinationSum(vector<int>& candidates, int target) {
        ...
        // sort the candidates before entering the recursive call for early
        // termination
    ...
    void backtrack(vector<int>& candidates, int const remainTarget,
                   size_t const startIndex, vector<int>& currentCombination,
                   vector<vector<int>>& result) {
        ...
        for (size_t i = startIndex; i < candidates.size(); i++) {
            ...
            // recursive call with newRemainTarget and carry the
            // currentCombination
            backtrack(candidates, newRemainTarget, i, currentCombination,
                      result);
